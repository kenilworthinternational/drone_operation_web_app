...
const ReportPart1_1 = ({ dateRange }) => {
  ...
  const fetchGroupData = useCallback(async () => {
    try {
      ...
      const result = await dispatch(fetchChartAllDataGroup({ payload, reportName: 'planAreasDetailedReport' }));
  ...
  const fetchPlantationData = useCallback(async (groupId) => {
    try {
      ...
      const result = await dispatch(fetchChartGroupDataGroup({ payload, reportName: 'planAreasDetailedReport' }));
  ...
  const fetchRegionData = useCallback(async (plantationId) => {
    try {
      ...
      const result = await dispatch(fetchChartPlantationDataGroup({ payload, reportName: 'planAreasDetailedReport' }));
  ...
  const fetchEstateData = useCallback(async (regionId) => {
    try {
      ...
      const result = await dispatch(fetchChartRegionDataGroup({ payload, reportName: 'planAreasDetailedReport' }));
