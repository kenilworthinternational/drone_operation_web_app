...
const BrokerRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const searchResult = await dispatch(baseApi.endpoints.searchBrokerByNIC.initiate(formData.nic));
      const existingBroker = searchResult.data;
      ...
      await dispatch(baseApi.endpoints.addBroker.initiate({
        name: formData.name,
