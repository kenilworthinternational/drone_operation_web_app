...
const IncompleteFieldsLeaderWise = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const result = await dispatch(baseApi.endpoints.getFieldsNotApprovedByTeamLead.initiate({
...
export default IncompleteFieldsLeaderWise;