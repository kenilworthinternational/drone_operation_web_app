...
const VehiclesRegistration = ({
  ...
  const handleSubmit = async (e, tab) => {
    ...
    if (tab === 'vehicles' && !(formData.vehicle_image instanceof File)) {
      setMessage('Please upload a vehicle photo.');
      setMessageType('error');
      return;
    }
    ...
    try {
      if (tab === 'drones') {
        ...
        if (formData.vehicle_image instanceof File) {
          formDataToSend.append('vehicle_image', formData.vehicle_image);
        }
