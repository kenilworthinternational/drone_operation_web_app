...
export const baseApi = createApi({
  ...
  tagTypes: [
    ...
    'HrLeave', 'HrLeaveAdmin', 'HrAttendance', 'HrRoster', 'KpiDefinitions', 'KpiRatingBands', 'KpiLeaderboard', 'KpiTasks', 'SmartKpiTemplates', 'SmartKpiFieldTypes', 'SmartKpiReviews', 'SmartKpiScopeStatus', 'HrmDashboard',
