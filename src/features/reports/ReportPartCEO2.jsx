...
const ReportPartCEO2 = ({ dateRange }) => {
 ...
 const fetchGroupData = useCallback(async () => {
  ...
  if (loading) return <div className="report-part2 loading"><div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px' }}>
    <Bars
      height="80"
      width="80"
      color="#004B71"
  ...
  return (
    <div className="report-part2">
      ...
      {selectedRegion ? (
          ...
          {loadingEstate ? (
            ...
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={processedEstateData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                ...
                <XAxis dataKey="estate_name" label={{ value: 'Estates', position: 'insideBottom', offset: -10, fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} />
                ...
                <Bar dataKey="fieldAreaInPlans" name="Field Area in Plans (Ha)" fill="#ed8936" stackId="a" barSize={40} />
        ...
        <div className="chart-container">
          ...
          {loadingRegion ? (
            ...
            <ResponsiveContainer width="100%" height={400}>
              ...
              >
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                <XAxis dataKey="region_name" label={{ value: 'Regions', position: 'insideBottom', offset: -10, fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} />
                <YAxis label={{ angle: -90, position: 'insideLeft', fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} tickFormatter={(value) => Number(value).toFixed(2)} />
                <Tooltip content={<CustomTooltip />} />
                <Legend verticalAlign="top" height={36} />
                <Bar dataKey="fieldAreaInPlans" name="Field Area in Plans (Ha)" fill="#ed8936" stackId="a" barSize={40} />
        ...
        <div className="chart-container">
          ...
          {loadingPlantation ? (
            ...
            <ResponsiveContainer width="100%" height={400}>
              ...
              >
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                <XAxis dataKey="plantation_name" label={{ value: 'Plantations', position: 'insideBottom', offset: -10, fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} />
                <YAxis label={{ angle: -90, position: 'insideLeft', fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} tickFormatter={(value) => Number(value).toFixed(2)} />
                <Tooltip content={<CustomTooltip />} />
                <Legend verticalAlign="top" height={36} />
                <Bar dataKey="fieldAreaInPlans" name="Field Area in Plans (Ha)" fill="#ed8936" stackId="a" barSize={40} />
        ...
        // Group View
        <div className="chart-container">
          <h2 className="chart-title">Group Covered Areas ({selectedType})</h2>
          {processedGroupData.length > 0 ? (
            <ResponsiveContainer width="100%" height={400}>
              ...
              >
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                <XAxis dataKey="group_name" label={{ value: 'Groups', position: 'insideBottom', offset: -10, fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} />
                <YAxis label={{ angle: -90, position: 'insideLeft', fill: '#4a5568' }} tick={{ fill: '#4a5568', fontSize: 14 }} tickFormatter={(value) => Number(value).toFixed(2)} />
                <Tooltip content={<CustomTooltip />} />
                <Legend verticalAlign="top" height={36} />
                <Bar dataKey="fieldAreaInPlans" name="Field Area in Plans (Ha)" fill="#ed8936" stackId="a" barSize={40} />
