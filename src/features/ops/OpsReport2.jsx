...
import { displayPlantation, estateListAcPlant, financeReport } from '../../api/api';
        ...
        const fetchReportData = async () => {
            if (selectedPlantation && selectedEstates.length > 0 && selectedDates[0] && selectedDates[1]) {
                try {
                    ...
                    const response = await financeReport(startDate, endDate, estateIds);
                    const processedData = [];
